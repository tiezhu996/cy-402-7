...
export async function list(req: Request, res: Response) {
  ...
  const data = await workHourService.listWorkHours(filters);
  res.json({ data });
}

export async function detail(req: Request, res: Response) {
  const data = await workHourService.getWorkHour(req.params.id);
  if (!data) {
...
export async function create(req: Request, res: Response) {
  ...
  const data = await workHourService.createWorkHour(input);
...
export async function summary(req: Request, res: Response) {
  ...
  const data = await workHourService.getCaseWorkHourSummary(caseId);
  res.json({ data });
}
